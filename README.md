...
3. Check results and cross-reference with pdf
    - **LMR-02-data-check.R** contains R code to assist with checking data, based on results from Python extract process.
...
4. Upload new data to Postgres database on AWS
    ...
    - if issues with database access, probably IP address-related; update as nec in AWS
